  ...
  <section class="bg-gray-200 text-white py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 ">
      <div class="flex flex-col items-center text-center">
        ...
        <a  href="tel:(443) 852-1000" class="flex items-start" style="background-color: #0f0f0f; color: #ffffff; font-weight: 500; padding: 0.75rem 1.6rem; border-radius: 0.5rem; transition: background-color 0.2s;" >
